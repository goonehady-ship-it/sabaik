...
export function HeroSlider() {
  ...
  const displaySlides = slides && slides.length > 0 ? slides : [
    { id: 1, title: "حلول ذكية لإدارة المخلفات والأنقاض", subtitle: "شريككم الموثوق في تأجير الحاويات ونقل الأنقاض بالرياض", imageUrl: "/hero1.jpg", ctaText: "اطلب الخدمة الآن" },
    { id: 2, title: "نحو بيئة مستدامة وخدمات أسرع", subtitle: "خبرة تمتد لأكثر من 6 سنوات في خدمة مشاريع الرياض", imageUrl: "/hero2.jpg", ctaText: "تعرف على خدماتنا" },
    { id: 3, title: "أسطول متكامل من الحاويات", subtitle: "حاويات بمختلف الأحجام تناسب جميع المشاريع", imageUrl: "/hero3.jpg", ctaText: "تصفح الحاويات" },
    { id: 4, title: "الجودة والسرعة والالتزام", subtitle: "فريق متخصص يعمل على مدار الأسبوع لخدمتكم", imageUrl: "/hero4.jpg", ctaText: "تواصل معنا" },
  ]
